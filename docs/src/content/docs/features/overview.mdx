...
description: How dart-query eliminates context rot with batch operations, DartQL selectors, and safety-first defaults, with token comparisons and workflow examples.
head:
  - tag: meta
    attrs:
      property: og:title
