...
| `priority` | integer | Priority level, `1` (lowest) to `5` (highest). Use [`get_config`](/dart-query/tools/discovery-config/#get_config) to see your workspace's label-to-number mapping. |
